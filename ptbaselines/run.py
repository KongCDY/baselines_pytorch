...
from ptbaselines.common.vec_env import VecFrameStack, VecNormalize, VecEnv
from ptbaselines.common.vec_env.vec_video_recorder import VecVideoRecorder
...
def get_alg_module(alg, submodule=None):
    ...
    try:
        ...
        alg_module = import_module('.'.join(['ptbaselines.algos', alg, submodule]))
    except ImportError:
        # then from rl_algs
